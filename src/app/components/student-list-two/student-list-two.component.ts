...
@Component({
  selector: 'app-student-list-two',
  templateUrl: './student-list-two.component.html',
  styleUrls: ['./student-list-two.component.scss']
})
export class StudentListTwoComponent implements OnInit {
stdsArr:Array<Istd>=[]
