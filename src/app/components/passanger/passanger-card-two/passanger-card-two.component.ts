...
@Component({
  selector: 'app-passanger-card-two',
  templateUrl: './passanger-card-two.component.html',
  styleUrls: ['./passanger-card-two.component.scss']
})
export class PassangerCardTwoComponent implements OnInit {
